package com.example.chuwenbin.spiderapp.net;
...
public class RequestManager {
     ...
     * @return
     */
    private <T> Call requestPostByAsynWithForm(String url, HashMap<String, String> paramsMap, final ReqCallBack<T> callBack) {
        try {
            FormBody.Builder builder = new FormBody.Builder();
            for (String key : paramsMap.keySet()) {
                builder.add(key, paramsMap.get(key));
